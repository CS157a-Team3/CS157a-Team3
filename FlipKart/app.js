...
const {logIn, signUp, storeFront, storeFrontCat, cart, newUser, existingUser, productPage, addToCart, removeItem, logOut, checkoutPage, checkout} = require('./routes/index');
